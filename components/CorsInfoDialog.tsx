  ...
  const corsFreendlyApis = [
    {
      ...
      description: "Тестовый REST API",
    },
    {
      name: "HTTPBin",
      url: "https://httpbin.org/get",
      description: "HTTP тестирование",
    },
    {
      name: "Dog API",
      url: "https://dog.ceo/api/breeds/image/random",
      description: "Случайные фото собак",
    },
    {
      name: "REST Countries",
      url: "https://restcountries.com/v3.1/all",
      description: "Информация о странах",
    },
    {
      name: "Cat Facts",
      url: "https://catfact.ninja/fact",
      description: "Факты о кошках",
    },
  ];
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-blue-50 p-3 rounded-lg text-sm">
              <p className="mb-2">
                <strong>1.</strong> Ваше приложение работает на{" "}
                <code>localhost:3000</code>
              </p>
              <p className="mb-2">
                <strong>2.</strong> API находится на другом домене (например,{" "}
                <code>api.github.com</code>)
              </p>
              <p>
                <strong>3.</strong> Браузер блокирует запрос, если API не
                разрешает доступ с вашего домена
              </p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-start gap-2">
                ...
                <div>
                  <strong>Включите прокси</strong> - поставьте галочку
                  "Использовать прокси (обход CORS)" в настройках тестов
                </div>
              </div>
              <div className="flex items-start gap-2">
                <Badge variant="secondary" className="mt-0.5">
                ...
                <div>
                  <strong>Используйте тестовые API</strong> из зеленого списка
                  выше - они специально созданы для браузерного тестирования
                </div>
              </div>
              <div className="flex items-start gap-2">
                <Badge variant="secondary" className="mt-0.5">
                ...
                <div>
                  <strong>Используйте Postman или curl</strong> для тестирования
                  API с CORS ограничениями
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-3 rounded-lg">
            ...
            <p className="text-xs text-muted-foreground">
              ...
              всех современных браузеров. Он защищает пользователей от
              вредоносных сайтов, которые могут пытаться получить доступ к
