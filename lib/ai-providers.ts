...
export class GeminiProvider implements AIProvider {
  ...
  async generateContent(
    ...
    try {
      ...
      throw new Error(
        `Не удалось получить ответ от Gemini: ${error instanceof Error ? error.message : "Неизвестная ошибка"}`,
      );
    }
  }
}
...
export class HuggingFaceProvider implements AIProvider {
  ...
  async generateContent(
    ...
    try {
      ...
      throw new Error(
        `Не удалось получить ответ от Hugging Face: ${error instanceof Error ? error.message : "Неизвестная ошибка"}`,
      );
    }
  }
}
